...
public interface InformationMapper {
	 ...
	 * @return
	 */
	public List<SchoolVO> selectSchoolInformation();
	/**
	 ...
	 * @return
	 */
	public List<CertificateVO> selectCertificateInformation();
	/**
	 ...
	 * @return
	 */
	public int updateProfileInformation(UsersVO users);
	 ...
	 * @return
	 */
	public int deleteSchool(SchoolVO school);
	 ...
	 * @return
	 */
	public int deleteCertificate(CertificateVO certificate);
